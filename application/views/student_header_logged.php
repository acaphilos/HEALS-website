...
<head>
    <title>FKI</title>
    <meta charset="utf-8">
    <meta name="description" content="Faculty of computering and informatics">
    <meta name="keywords" content="FKI, UMS, software engineering, data science, sabah">
...
<!-- Header Section -->
    <header class="header-section">
      <a href="<?=base_url()?>StudentMain" class="site-logo"> <img src="<?=base_url()?>public/img/logofki-1.png" alt="logo"></a>
      <div class="nav-switch">
        <i class="fa fa-bars" style="color:#1c1c1c;"></i>
      </div>

      <div class="nav-wrap">
        <ul class="nav-menu">
          <li><a href="<?=base_url()?>StudentProfile">Edit Profile</a></li>
